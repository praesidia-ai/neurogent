 ...
 * Registry lives at: https://raw.githubusercontent.com/neurosdk/neurogent-shell/main/registry/index.yaml
...
export function installPack(packName: string, targetDir: string = '.'): string {
  ...
  const destPath = path.resolve(targetDir, 'neurogent-shell.yaml');
